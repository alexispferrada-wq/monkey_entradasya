    ...
    return (
      <div className="glass-card rounded-2xl p-8 text-center space-y-4">
        ...
        <p className="text-zinc-400">
          {tipo === 'terraza' 
            ? 'Tu reserva en la Terraza está confirmada. Te hemos enviado un correo con los detalles.' 
    ...
    <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 space-y-6">
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            { id: 'terraza', label: 'Terraza (Gratis)' },
            { id: 'grill', label: 'Monkey Grill ($10.000)' },
            { id: 'cumpleanos', label: 'Cumpleaños ($10.000)' },
          ].map((op) => (
