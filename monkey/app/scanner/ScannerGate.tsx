...
const STORAGE_KEY = 'scanner_auth_monkey'
const CLAVE_CORRECTA = 'monkey2024'
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white mb-2">Scanner Monkey</h1>
        ...
        <p className="text-slate-600 text-xs text-center mt-6">Solo para uso del personal de Monkey</p>
      </div>
    </div>
  )
}
