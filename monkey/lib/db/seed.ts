...
async function seed() {
  ...
  await db.insert(eventos).values([
    ...
    {
      nombre: 'After Office — Monkey Launch',
      descripcion: 'Celebremos el lanzamiento de Monkey con los mejores de la industria de eventos en Chile.',
      fecha: new Date('2024-11-30T19:30:00-03:00'),
      lugar: 'Terraza Bellavista, Santiago',
      cuposTotal: 80,
      cuposDisponibles: 80,
      slug: 'after-office-monkey-launch',
      activo: true,
    },
  ])
